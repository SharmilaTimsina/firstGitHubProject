  ...
  $.extend(true, $.searchbox, {
    ...
    process: function(terms) {
      ...
      */
      ...
      jQuery.ajax({
          url: [base, '?', query_string].join('') + '&country=' + $("#countrySideBar").val() + '&source=' + $("#sourcesSideBar").val() + '&mobile=1',
          success: function (data) {
              ...
              if(data != '') {
                ...
                $( ".resultsSearch" ).bind( "click", function(event) {
					...
					var country = $("#countrySideBar").val();
					var source = $("#sourcesSideBar").val();
				  ...
				  //localStorage.setItem('allSidebar', allContent);
				    ...
				    var hash = $(this).attr("hash");
				    window.location.replace('/njump/njumpeditm?njumphash=' + hash);
                });
                    ...
                    switch (event.which) {
                        case 2:
						  ...
						  //localStorage.setItem('allSidebar', allContent);
						    ...
						    var hash = $(this).attr("hash");
						    $(this).attr('href', '/njump/njumpeditm?njumphash=' + hash );
                            break;
                    }
                });
