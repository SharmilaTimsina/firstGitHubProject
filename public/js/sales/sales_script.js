		...
		if(countries)
		{
			...
			$.ajax({
				...
				success:function(obj){
                    ...
                    rows+="<tr  class='crm-lightgrey'><td scope='row'><b>"+af+"</b></td><td>"+clicks+"</td><td>"+conversions+"</td><td>"+CPA+"</td><td>"+ CR+"%</td><td>"+EPC+"</td></tr>";
				...
				$("#table").empty;
					...
					else
					{
						...
						EPC=parseFloat(Math.round(EPC * 100) / 100).toFixed(4);
						 ...
						 rows1+="<tr class='crm-darkgrey'><td scope='row'><b>TOTAL</b></td><td>"+clicks+"</td><td>"+conversions+"</td><td>"+CPA+"</td><td>"+ CR+"%</td><td>"+EPC+"</td></tr>";
					}
					$("#table").append(rows1);
