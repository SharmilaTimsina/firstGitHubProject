        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                _cnbtn:function(){
                        ...
                        if(O.E.data('selectoutside') == 1) {
                            
                            /*  
                            $(".formcountry").find('.options li').each(function(){
                            ...
                            */
                            ...
                            O.E.find('option:selected').each(function () { this.selected = true; });
                ...
                selAllState: function () {
                    ...
                    if (settings.selectAll) {
                        var sc = 0, vc = 0, filterOptionCount = 0;
                        O.optDiv.find('li.opt').not('.hidden').each(function (ix, e) {
                        ...
                        if ((sc == vc) && (O.optDiv.find('li.opt').length == filterOptionCount)) O.selAll.removeClass('partial').addClass('selected');
                            ...
                            switch (e.which) {
                                ...
                                case 13: // enter
                                    if (O.is_opened) {
                                        ...
                                        if($(this).find('select').attr('typee') == 1) {
...
function getSumoSelects(sumoSelect, type) {
    var obj = [],
    	items = '';

    //array with vals
    if(type == 1) {
    	$(sumoSelect + ' option:selected').each(function(i) {
    	  obj.push($(this).val());
    	  //$(sumoSelect)[0].sumo.unSelectItem(i);
    	});
    ...
    //array with text
    	...
    	return obj;
    //if val is sellected return array with all ['ALL']
    } else if(type == 3) {
    	if($(sumoSelect).parent().find(".select-all").hasClass("selected") && !$(sumoSelect).parent().find(".select-all").hasClass("partial")) {
    		obj.push('ALL');
    		return obj;
    	} else {
    		$(sumoSelect + ' option:selected').each(function(i) {
