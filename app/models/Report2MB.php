...
class Report2MB extends Model {
    ...
    public function getMainReportResult($sdate, $edate, $country, $permission, $aff = null) {
        try {
    ...
    public function getDaysTotal2($sdate, $edate, $country, $countries, $sources, $aggs, $aff = null) {
        try {
            ...
            //mail('martim.barone@mobipium.com','getDaysTotal2 took'. $interval,$sql . '   rev:'.$revenue);
    ...
    public function getDayTotal2($country, $countries, $sources, $aggs, $aff = null) {
        try {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com','getDayTotal2 took'. $interval,$sql . '   rev:'.$revenue);
            return array($clicks, $conversions, $revenue);
        } catch (Exception $ex) {
            mail('martim.barone@mobipium.com', __METHOD__, $sql . "\n" . $ex->getMessage());
        }
    ...
    public function getLastDaysAvg2($sdate, $country, $countries, $sources, $aff = null, $aggs = null) {
        try {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'getLastDaysAvg2 time ' . $interval, $sql);
            return $res;
        } catch (Exception $ex) {
            mail('martim.barone@mobipium.com', __METHOD__, $sql . "\n" . $ex->getMessage());
        }
    ...
    public function getOperatorReport2($sdate, $edate, $country, $countries, $sources, $aggs, $aff = null) {
        try {
            ...
            $sql = 'SELECT insertDate as insert_date, subid as sub_id, c_hash, campaign, upper(campaign_country) as campaign_country, '
                    . ' upper(user_country) as user_country, m.agregator as agregator,a.agregator as agregatorName ,source, mobileBrand as operator, ISP as isp, osType as os, '
                    . ' browserName as browser, mobileTest as mobilet, ad , conversions, '
                    . ' revenue,clicks, EPC, CR '
                    . ' FROM OperatorReport m INNER JOIN Sources ON Sources.id = m.source INNER JOIN Agregators a ON m.agregator = a.id '
                    ...
                    . (isset($aggs) ? ' AND m.agregator IN (' . $aggs . ') ' : '' );
            $res = $this->getDi()->getDb4()->query($sql)->fetchAll();
            //mail('martim.barone@mobipium.com', 'OperatorReport2 ' , $sql);
            return $res;
        } catch (Exception $e) {
            mail('martim.barone@mobipium.com', __METHOD__, $sql . "\n" . $e->getMessage());
        }
    ...
    public function getMjumpResults($auth, $sdate, $edate, $sources, $country) {
        ...
        try {
            $sql = 'SELECT insertDate,lpName,page,ad,subid,userCountry,mobileBrand as carrier,browserName as browser,mobileTest as OS,subid, fkSource as source, SUM(lpclicks) as lpClicks, SUM(clicks) AS clicks, SUM(conversions) AS conversions,SUM(revenue) AS revenue '
    ...
    public function getGeneralStatisticsCountryAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null, $sourcetype = null, $operator = null) {
        try {
            ...
            $statement .= $fromStatement . $whereStatement . ' GROUP BY r.datePeriod, id , name) B GROUP BY id ORDER BY ' . ((isset($countries) || isset($sources) || isset($aff)) ? ' revenues DESC ' : ' id ');
            //mail('martim.barone@mobipium.com', 'getGeneralCountryAvg', '$country =' . $country . '$agg=' . $agg . ', $campaign=' . $campaign . '$source=' . $source . "\n" . '  statement =' . $statement);
            $a = new DateTime();
            $res = $this->getDi()->getDb4()->query($statement)->fetchAll();
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'getGeneralStatisticsCountryAvg time ' . $interval, $statement);
            return $res;
        } catch (Exception $e) {
            mail('martim.barone@mobipium.com', __METHOD__, $statement . "\n" . $e->getMessage());
        }
    }
    ...
    public function getGeneralStatisticsSourcesAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null, $sourcetype = null, $operator = null) {
        ...
        try {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'getGeneralStatisticsSourcesAvg time ' . $interval, $statement);
            return $res;
        } catch (Exception $e) {
            mail('martim.barone@mobipium.com', __METHOD__, $statement . "\n" . $e->getMessage());
        }
    ...
    public function getGeneralStatisticsAggregatorsAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null, $sourcetype = null, $operator = null) {
        try {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'getGeneralStatisticsAggregatorsAvg time ' . $interval, $statement);
            return $res;
        } catch (Exception $e) {
            mail('martim.barone@mobipium.com', __METHOD__, $statement . "\n" . $e->getMessage());
        }
    ...
    public function getGeneralStatisticsAggCampaignsAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null, $sourcetype = null, $operator = null) {
        try {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'getGeneralStatisticsAggCampaignsAvg time ' . $interval, $statement);
            return $res;
        } catch (Exception $e) {
            mail('martim.barone@mobipium.com', __METHOD__, $statement . "\n" . $e->getMessage());
        }
    ...
    public function getGeneralStatisticsOperatorsAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null, $operator = null, $sourcetype = null) {
        try {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'getGeneralStatisticsOperatorsAvg time ' . $interval, $statement);
            return $res;
        } catch (Exception $e) {
            mail('martim.barone@mobipium.com', __METHOD__, $statement . "\n" . $e->getMessage());
        }
...
//WHERE ' . ($affRes != '' ? $affRes : ' 0=0 '). ($join_type == 'INNER' ? ' AND conversions > 0 ' : '').'
        //mail('martim.barone@mobipium.com', 'getOpDailyResult', $sql);
    ...
    public function getPayoutResult($sdate, $edate, $source, $countries, $sources, $aff = null) {
        ...
        //mail('martim.barone@mobipium.com','getPayoutResult', $sql);
        return $this->getDi()->getDb2()->query($sql)->fetchAll();
    }
    ...
    public function reportbyhour($sdate, $edate, $country, $countries, $sources, $aggs, $aff = null) {
        ...
        $sql = 'SELECT B.* FROM (SELECT datePeriod as Date, timePeriod as Hour, m.campaign as Campaign,hashmask as Campaign_Hash,m.country as Country,r.sourceid as Source,m.agregator as Agregator,r.subid as Subid,r.clicks as Clicks,r.conversions as Conversions'
                . ',r.revenues as Revenue,r.revenues/r.clicks as EPC,r.conversions/r.clicks as CR,ad as Ad FROM R__HourlyAggCampaignSourceOperator r inner join Mask m on r.hashmask = m.hash '
    ...
    public function getNetworkResult($startDate, $endDate, $convTableMonth, $source, $country, $countries, $netArray, $aff = null) {
		...
		GROUP BY t1.countryCode, t2.clickid, ' . $netArray[$source][0] .
            ...
            //mail('martim.barone@mobipium.com', 'today network report', $sql);
        ...
        if (date("Y-m-d") > date("Y-m-d", strtotime($startDate))) {
            ...
            //mail('martim.barone@mobipium.com', 'previous days network report', $sql);
    ...
    public function getDayTotal($country, $countries, $sources, $aggs, $aff = null) {
        ...
        //mail('martim.barone@mobipium.com', 'query1 getDayTotal time:' . $interval, $query1);
        $a = new DateTime();
        $res2 = $this->getDi()->getDb2()->query($query2)->fetchAll();
        $b = new DateTime();
        $interval = $a->diff($b)->format("%h:%i:%s");
        //mail('martim.barone@mobipium.com', 'query2 getDayTotal time:' . $interval, $query2);
    ...
    public function getDaysTotal($sdate, $edate, $country, $countries, $sources, $aggs, $aff = null) {
        ...
        if ($sdate < date('Y-m-d')) {
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'old clicks time:' . $interval, $query1);
        }
        if ($edate >= date('Y-m-d')) {
            $affRes = $this->getSourcesByAff2($aff, 0);
            ...
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'daily clicks time:' . $interval, $query2);
            $a = new DateTime();
            $dailyConversions = $this->getDi()->getDb2()->query($query3)->fetchAll();
            $b = new DateTime();
            $interval = $a->diff($b)->format("%h:%i:%s");
            //mail('martim.barone@mobipium.com', 'daily rev and conversions' . $interval, $query3);
        }
    ...
    public function getGeneralCountryAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null) {
        ...
        $statement .= $fromStatement . $whereStatement . ' GROUP BY CAST(r.datetimePeriod as DATE), id , name) B GROUP BY id ORDER BY revenues DESC';
        //mail('martim.barone@mobipium.com', 'getGeneralCountryAvg', '$country =' . $country . '$agg=' . $agg . ', $campaign=' . $campaign . '$source=' . $source . "\n" . '  statement =' . $statement);
    ...
    public function getGeneralOperatorsAvg($s, $e, $hs, $he, $countries, $sources, $aggregators, $totalsOrAvg, $country = 'ALL', $agg = 'allaggs', $campaign = 'allcampaigns', $source = 'allsrc', $aff = null, $operator = null) {
        ...
        //mail('martim.barone@mobipium.com', 'getGeneralOperatorsAvg', '$country =' . $country . '$agg=' . $agg . ', $campaign=' . $campaign . '$source=' . $source . "\n" . '  statement =' . $statement . "\n");
    ...
    public function getAggData($sdate, $edate, $selectCountry, $selectAgg, $selectCampaign, $selectRurl, $selectOperator, $orderby, $countries, $sources, $aggregators, $aggsid = null, $campaignsid = null, $operators = null, $aff = null, $ccs = null) {
        ...
        if ($sdate < date('Y-m-d')) {
            ...
            //mail('martim.barone@mobipium.com', 'aggregator', $sql);
        ...
        if ($edate == date('Y-m-d')) {
            ...
            //mail('martim.barone@mobipium.com','sql2',$sql2);
