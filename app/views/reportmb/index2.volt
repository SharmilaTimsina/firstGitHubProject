...
{% block scriptimport %}    
<script src="http://mobisteinreport.com/js/reportmb/index2.js"></script>
...
<script src="http://mobisteinreport.com/js/datepickerjst/daterangepicker.js"></script>
<script src="http://mobisteinreport.com/js/datepickerjst/moment.min.js"></script>
<link rel="stylesheet" type="text/css" href="http://mobisteinreport.com/js/datepickerjst/daterangepicker.css" />
            ...
            <div class="col-md-12"> 
                <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        <form role="form" class="well" action="http://mobisteinreport.com/reportmb/main">
                            <fieldset>
                ...
                <div class="col-md-3">
                    <div class="panel-heading">
                        <h3 class="panel-title simple-title">Operator Report</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" class="well" action="http://mobisteinreport.com/reportmb/operator">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control sdate datescurrentdate"  name="s" type="text" value="">
                                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        <form id="formmjumpreport" role="form" class="well">
                            <fieldset>
                                <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title simple-title">Network Report</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" class="well" action="http://mobisteinreport.com/reportmb/network">
                            <fieldset>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select id="so" name="so" class="search-box-sel-all">
                                        <option value="95">Adamoads</option>
                                        <option value="81">AdCash</option>
										<option value="187">AdEagle Media</option>
                                        <option value="38">AdExpansion</option>
                                        <option value="165">Adsfly</option>
                                        <option value="100">AdsTerra</option>
                                        <option value="5">AdultModa</option>
										<option value="222">BravoMedia</option>
                                        <option value="1">BuzzCity</option>
                                        <option value="148">Clickadu</option>
										<option value="150">ClickPapa</option>
										<option value="211">DNTX</option>
                                        <option value="23">Exoclick eu</option>
                                        <option value="91">Exoclick usd</option>
                                        <option value="166">Exoclick2</option>
                                        <option value="386">ExoclickMalgo</option>
                                        <option value="116">Fogzy</option>
                                        <option value="96">Gunggo</option>
										<option value="175">Headway Digital</option>
										<option value="246">THilltopads</option>
                                        <option value="35">JuicyAds</option>
                                        <option value="106">KimiaOpTester</option>
                                        <option value="103">Media Globe</option>
                                        <option value="127">MediaHub</option>
                                        <option value="111">Mobadge</option>
                                        <option value="107">Mobusi</option>
                                        <option value="169">Mobusi2</option>
										<option value="251">MobusiMainstream</option>
                                        <option value="154">Mobusi adnetwork</option>
										<option value="173">OperaMediaWorks</option>
                                        <option value="37">PlugRush</option>
                                        <option value="114">Pollux</option>
                                        <option value="61">PopAds</option>
										<option value="382">PopAds2</option>
										<option value="212">PopMyAds</option>
                                        <option value="51">PopCash</option>
                                        <option value="94">Popunder Net</option>
                                        <option value="83">Propellerads</option>
                                        <option value="385">Propellerads2</option>
                                        <option value="209">SelfServePlatform</option>
                                        <option value="47">Traffic Junky</option>
                                        <option value="56">Traffic Shop</option> 
                                        <option value="59">TrafficFactory</option>
                                        <option value="168">TrafficFactory2</option>
                                        <option value="70">TrafficForce</option>
                                        <option value="167">TrafficForce2</option>
                                        <option value="153">TrafficHolder</option>
                                        <option value="98">TrafficHunt</option>
                                        <option value="153">TrafficPen</option>
                                        <option value="174">TrafficStars</option>
                                        <option value="354">Ungads</option>
                                        <option value="40">xxxWebTraffic</option>
                                        <option value="322">Vserv</option>
                                        <option value="229">MobusiAff</option>
                                        <option value="362">ExoDating</option>
                                        <option value="364">TrafficStarsDating</option>
                                        <option value="365">TrafficJunkieDating</option>
                                        <option value="367">MobusiDating</option>
                                        <option value="368">PlugDating</option>
                                        <option value="369">PropellerDating</option>
                                        <option value="370">PopAdsDating</option>
                                        <option value="289">ReachEffect</option>
                                        <option value="346">wwwpromoter</option>
                                    </select>    
                                </div>
                                <div class="form-group">
                                    <select multiple="multiple"  id="ccN" name="cc[]" class="search-box-sel-all">
                                    </select>
                                </div>
        ...
        <?php } ?>
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        <form role="form" class="well" action="/reportmb/payoutreport">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control sdate datescurrentdate"  name="s" type="text" value="">
                                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        <form role="form" class="well" action="/reportmb/reportbyhour">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control datetimepicker1" name="s" type="text" value='<?php echo $current_date . " 00:00:00" ;?>'>
                                </div>
                                <div class="form-group">
                                    <input class="form-control datetimepicker1" name="e" type="text" value="<?php echo $current_datetime; ?>">
                                </div>
                                <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        <form role="form" class="well" action="http://mobisteinreport.com/reportmb/statistics2">
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="simple-label">Aggregators</label>
                                    <select multiple="multiple"  class="form-control search-box-sel-all" id="aggID" name="agg[]">    
                                        <option value="allaggs">All aggregators</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="opID" name="selectedOperator">
                                        <option value="allops">All operators</option>
                                ...
                                <div class="form-group">
                                    <label class="simple-label">Campaigns</label>
                                        ...
                                        <option value="allcampaigns">All campaigns</option>
                ...
                <?php } ?>
                    <div class="panel-heading">
                        <h3 class="panel-title simple-title">Aggregators Report</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" class="well" action="/report/aggSummary">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="simple-label">Campaigns</label>
                                    <input class="form-control" placeholder="search campaign" id="campaignsfilter" type="text">
                                    <select class="form-control" id="aggCampaignid" name="campaignsid[]" multiple>
                                        <option value="allcampaigns" selected="selected">All Campaings</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="aggAggsID" name="aggsid[]" multiple>
                                        <option value="allaggs" selected="selected">All aggregators</option>
                                      
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="simple-label">Operators</label>
                                    <input class="form-control" id="operatorsfilter" placeholder="search operator" type="text">
                                    <select class="form-control" id="operatorsid" name="operatorsid[]" multiple>
                                        <option value="alloperators" selected="selected">All Operators</option>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input name="selectoperator" type="checkbox"> Operator
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input name="selectaggregator" type="checkbox" checked> Aggregator
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input name="selectcampaign" type="checkbox" checked> Campaign
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
...
<script>
	...
	var campaings = <?php echo "'" .  $campaignSelectList . "'" ?> ;
	...
	$("#formmjumpreport").submit(function(e) {       
	  ...
	  formData.append('cc',  $('#ccOP2').multipleSelect("getSelects"));
			...
			$.ajax({
				url: 'http://mobisteinreport.com/report/mjump',
				type: 'POST',
				data: formData,
				async: true,
	  ...
	  */
	   ...
	   window.location.assign('http://mobisteinreport.com/reportmb/mjump?s=' + $("#startdatemjump").val() + "&e=" + $("#enddatejump").val() + "&cc=" + getSumoSelects('#ccOP2', 0));
    });
